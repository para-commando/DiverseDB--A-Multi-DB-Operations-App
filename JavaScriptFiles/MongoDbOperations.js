...
exports.mongoDbCreateOperations = void 0;
...
const mongoDbCreateOperations = (connection) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield mongooseModels_1.mongooseModels.myTestModel_ops({
        ...
        yield mongooseModels_1.mongooseModels.PersonModel_ops({
            connection: connection,
        ...
        // ************************ UseCase-3 *******************************
        yield mongooseModels_1.mongooseModels.UserModel_ops({
            connection: connection,
            modelName: 'UserModel',
            collectionName: 'UserCollection',
        });
        yield mongooseModels_1.mongooseModels.PostsModel_ops({
            connection: connection,
